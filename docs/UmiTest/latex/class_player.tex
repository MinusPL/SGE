...
\begin{center}
\leavevmode
\includegraphics[width=152pt]{class_player__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=152pt]{class_player__coll__graph}
\end{center}
\end{figure}
...
Uses own player model (in this case a ball). Can be moved by arrow keys 
